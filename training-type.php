...
<head>
    ...
    <title>Training Type - HRMS admin template</title>
                                    ...
                                    <td class="text-end">
                                        <div class="dropdown dropdown-action">
                                            ...
                                            <div class="dropdown-menu dropdown-menu-right">
                                                <a class="dropdown-item" href="#" data-bs-toggle="modal" data-bs-target="#edit_type"><i class="fa fa-pencil m-r-5"></i> Edit</a>
