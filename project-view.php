            ...
            <div class="page-header">
                <div class="row align-items-center">
                    ...
                    <div class="col-auto float-end ms-auto">
                        ...
                        <a href="task-board.php" class="btn btn-white float-end m-r-10" data-bs-toggle="tooltip" title="Task Board"><i class="fa fa-bars"></i></a>
                    </div>
                </div>
            </div>
            <!-- /Page Header -->
                        ...
                        <div class="card-body">
                            ...
                            <table class="table table-striped table-border">
                                <tbody>
                                    ...
                                    <tr>
                                        <td>Created by:</td>
                                        <td class="text-end"><a href="profile.php">Barry Cuda</a></td>
                                    </tr>
                                    <tr>
                                        <td>Status:</td>
